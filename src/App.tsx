 ...
 * @LastEditTime: 2021-05-10 11:59:32
 */
...
const App: React.FC = () => {
  return (
    <div>
      ...
      <Input prepend='https://' size={InputSize.Small} placeholder="请输入网站地址" />
      <Input append='@xdf.cn' size={InputSize.Small} placeholder="请输入邮箱地址" />
